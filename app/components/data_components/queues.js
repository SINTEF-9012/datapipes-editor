(function() {
  ...
  bigml.Queue = bigml.Component.extend({
    markup: '<g class="rotatable"><g class="scalable"><path  d="M 0,66.66667 0,0 l 66.666666,0 33.33333,33.33333 0,66.66667 -66.666664,0 z"/><path class="front body" d="m 100,33.333333 -66.666667,0 0,66.666667 L 100,100 100,33.333333 Z M 83.333333,16.666667 83.333333,25 25,25 l 0,58.333333 -8.333333,0 0,-66.666666 66.666666,0 z M 66.666667,0 l 0,8.333333 -58.333334,0 0,58.333334 L 0,66.666667 0,0 66.666667,0 Z" transform="translate(20,0)"/><image x="56" y="56" width="64" height="64"></image></g><g class="inPorts"/><g class="outPorts"/></g>',
  ...
  bigml.QueueView = joint.shapes.devs.ModelView;
  ...
  bigml.Kafka = bigml.Queue.extend({
    defaults: joint.util.deepSupplement({
      ...
      attrs: {
        image: {
          'xlink:href': 'assets/img/kafka.png'
        }
      }
    }, bigml.Queue.prototype.defaults)
  });
  bigml.KafkaView = joint.shapes.devs.ModelView;
